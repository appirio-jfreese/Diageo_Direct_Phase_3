    ...
    $.fn.imgscale = function(params) {
        ...
        function _scaleImage( $img, $parent, _loadedImg ) {
            ...
            function _calulateScale() {
                if( (_imgWidth * _parentHeight / _imgHeight ) >= _parentWidth )
                    _reiszeImage( 't' );
                else
                    _reiszeImage( 'w' );
            }
            ...
            function _showImage(){
				...
				$img.parent().removeClass('imgLoading');
				$img.stop().animate({opacity: 1}, params.fade, function(){
				});
